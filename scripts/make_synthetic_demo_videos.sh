...
for f in $SRC_FOLDER/synthetic-posenoise/baseline/*; do
    ...
    OVERLAY_OURS=overlay_images/overlay_600x400_optimized.png ./scripts/combine_synthetic_videos.sh \
...
for f in $RENDERS_FOLDER/baseline/*; do
    ...
    OVERLAY_OURS=overlay_images/overlay_600x400_compensated.png ./scripts/combine_synthetic_videos.sh \
...
for f in $RENDERS_FOLDER/baseline/*; do
    ...
    ./scripts/combine_synthetic_videos.sh \
        "$RENDERS_FOLDER/baseline/$CASE/demo_video.mp4" \
